...
const setLanguageConstants = (language) => {
  switch (language) {
    case "de": // German
      pureprivacyTitle = "Cookies und die Shoutcast Tools";
      ...
      pureprivacyURL = "https://de.shoutcast-tools.com/cookies/";
      break;
    default:
      pureprivacyTitle = "Cookies and Shoutcast Tools";
      ...
      pureprivacyURL = "https://de.shoutcast-tools.com/en/cookies/";
      break;
  }
};
...
const setCookie = (name, value, days) => {
  ...
  document.cookie = `${name}=${value || ""}${expires}; path=/; domain=.shoutcast-tools.com`;
};
