...
const setLanguageConstants = (language) => {
  switch (language) {
    case "de": // German
      ...
      pureprivacyURL = "https://de.shoutcast-tools.com/kontakt/cookies/";
      break;
    default:
      ...
      pureprivacyURL = "https://de.shoutcast-tools.com/en/contact/cookies/";
      break;
  }
};
...
const setCookie = (name, value, days) => {
  ...
  document.cookie = `${name}=${
    value || ""
  }${expires}; path=/; domain=.shoutcast-tools.com`;
};
