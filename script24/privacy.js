...
const setLanguageConstants = (language) => {
  switch (language) {
    case "de": // German
      pureprivacyTitle = "Cookies und Script24.net";
      ...
      pureprivacyURL = "https://www.script24.net/cookies/";
      break;
    default:
      pureprivacyTitle = "Cookies and Script24.net";
...
const setCookie = (name, value, days) => {
  ...
  document.cookie = `${name}=${value || ""}${expires}; path=/; domain=.script24.net`;
};
