...
function setLanguageConstants(language) {
  switch (language) {
    case "de": // German language
      ...
      var pureprivacyTitle = "Cookies und SPRadio";
      ...
      var pureprivacyURL = "https://www.spradio.eu/kontakt/cookies/";
      break;
    default:
      // Default to English language
      // Set constants for English language
      var pureprivacyTitle = "Cookies and SPRadio";
      ...
      var pureprivacyURL = "https://www.spradio.eu/en/contact/cookies/";
      break;
  }
}
...
function setCookie(name, value, days) {
  ...
  document.cookie = name + "=" + (value || "") + expires + "; path=/; domain=.spradio.eu";
}
