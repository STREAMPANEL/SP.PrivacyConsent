...
const setLanguageConstants = (language) => {
  switch (language) {
    case "de": // German
      pureprivacyTitle = "Cookies und WebradioTop100.de";
      pureprivacyDesc =
      ...
      pureprivacyURL = "https://www.webradiotop100.de/cookies.php";
      break;
    default: // Default to English
      pureprivacyTitle = "Cookies and WebradioTop100.de";
      pureprivacyDesc =
      ...
      pureprivacyURL = "https://www.webradiotop100.de/en/cookies.php";
      break;
  }
};
...
const setCookie = (name, value, days) => {
  ...
  document.cookie = `${name}=${
    value || ""
  }${expires}; path=/; domain=.webradiotop100.de`;
};
