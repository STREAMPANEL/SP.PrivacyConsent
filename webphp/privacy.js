...
const setLanguageConstants = (language) => {
  switch (language) {
    case "de": // German
      pureprivacyTitle = "Cookies und WEB-PHP";
      ...
      pureprivacyURL = "https://www.web-php.de/index.php?seite=web_php_und_cookies";
      break;
    default:
      pureprivacyTitle = "Cookies and WEB-PHP";
...
const cookieHelper = {
  setCookie: (name, value, days) => {
    ...
    document.cookie = `${name}=${value || ""}${expires}; path=/; domain=.web-php.de`;
  },
